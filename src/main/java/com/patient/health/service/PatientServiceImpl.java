...
public class PatientServiceImpl implements PatientService {
	...
	@Override
	public Optional<Patient> updatePatient(Integer patientId, PatientRequest patientRequest)
			throws ResourceNotFoundException {
		logger.info("PatientService...updatePatient details...patientId = [{}]...patient = [{}]", patientId,
				patientRequest);
